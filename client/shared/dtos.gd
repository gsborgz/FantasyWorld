...
class ClientCharacter:
	...
	func _init(_id: String = "", _name: String = "", _instancePath: String = "", _x: float = 0.0, _y: float = 0.0, _direction: Direction = Direction.DOWN, _userId: String = "", _speed: float = 0.0, _lastPositionUpdate: int = 0, _is_moving: bool = false, _is_running: bool = false):
		id = _id
		name = _name
